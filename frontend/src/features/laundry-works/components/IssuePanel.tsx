  ...
  if (error) {
    return (
      <section className="rounded-2xl border border-red-100 bg-red-50 p-4 text-red-800 shadow-sm">
        <h2 className="text-base font-semibold">ปัญหาที่พบ</h2>
              ...
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0">
                  <p className="text-sm font-medium text-slate-900">
                    {issue.title || issue.issueType || issue.type || 'ปัญหา'}
                  </p>
                ...
                <span className="shrink-0 rounded-full bg-white px-2 py-1 text-xs font-medium text-slate-600 ring-1 ring-slate-200">
                  {issue.status || 'open'}
                </span>
              </div>
            </article>
