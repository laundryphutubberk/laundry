...
export function BottomActionBar({ actions = {}, state = {}, loading = false, error = null }: BottomActionBarProps) {
  ...
  return (
    <div className="sticky bottom-0 z-20 border-t border-slate-200 bg-white/95 px-4 py-4 shadow-[0_-10px_28px_rgba(15,23,42,0.08)] backdrop-blur supports-[backdrop-filter]:bg-white/85">
      <div className="mx-auto flex max-w-6xl flex-col-reverse gap-3 sm:flex-row sm:items-center sm:justify-between">
        <button
          ...
          className="rounded-xl border border-slate-200 bg-white px-6 py-3 text-sm font-semibold text-slate-700 shadow-sm hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-50"
        >
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          {actions.destructive ? (
            <button
              ...
              className="rounded-xl border border-red-200 bg-white px-6 py-3 text-sm font-semibold text-red-700 hover:bg-red-50 disabled:cursor-not-allowed disabled:opacity-50"
            >
          ...
          {canContinue ? (
            <button
              ...
              className="rounded-xl bg-blue-900 px-7 py-3 text-sm font-bold text-white shadow-sm hover:bg-blue-800 disabled:cursor-not-allowed disabled:opacity-50"
            >
