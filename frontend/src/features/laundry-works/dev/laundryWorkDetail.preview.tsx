  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-950">
      <main className="mx-auto flex max-w-7xl flex-col gap-4 px-4 py-4 pb-24 md:px-6 md:py-6">
        <section className="rounded-2xl border border-blue-100 bg-blue-50 p-4 text-blue-900 shadow-sm">
          <p className="text-xs font-semibold uppercase tracking-wide">Development Preview</p>
          <h1 className="mt-1 text-lg font-semibold">Laundry Work Detail</h1>
