...
Authority: Architectural capability catalog

## Purpose

This index is the durable architectural overview of Operational Capabilities recognized by the project.

It is an architectural catalog only. It is not a roadmap, execution state, project status tracker, or replacement for `STATE.json`.
...
| Laundry Claim Operational Capability V1 | Transform an eligible Laundry Issue into a managed Claim lifecycle while preserving Issue, Work, inventory, counting, movement, image, and financial boundaries. | `project-os-v2/project/capabilities/LAUNDRY-CLAIM-OPERATIONAL-BLUEPRINT-V1.md` | Complete | Complete | Complete | Complete | `COMPLETE` | Locked Claim Blueprint; Claim implementation, verification, integration, and retrospective records |
